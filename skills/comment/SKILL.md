...
Run `highlight-state mode-on` using the Bash tool, then run `highlight-snapshot` to capture your last response as the target for validating highlighted quotes against.
